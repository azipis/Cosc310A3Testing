...
public class EspressoSaveReportTest {
    ...
    @Test
    public void espressoSaveReportTest() {
        ...
        ViewInteraction navigationMenuItemView = onView(
                allOf(withId(R.id.nav_veiw_report),
                        childAtPosition(
        ...
        ViewInteraction materialButton2 = onView(
                allOf(withId(R.id.buttonSaveReport), withText("Save Report"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
